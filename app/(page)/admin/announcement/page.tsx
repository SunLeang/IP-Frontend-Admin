  ...
  const [announcements, setAnnouncements] = useState([
    {
      ...
      description:
        "We would like to inform all of our attendee that we have a made a map direction to guide everyone and have a wonderful time on the event",
      image:
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              {announcements.map((announcement) => (
                <div
                  key={announcement.id}
                  className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-md max-w-sm"
                >
